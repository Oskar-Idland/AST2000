...
%\usepackage[style=science, backend=biber]{biblatex} TODO: Remove Comment
...
If not stated otherwise, the theory in this paper is based on the AST2000 lecture notes%~\parencite[][]{lecture_notes_part1d} TODO: Remove Comment
\subsection{An Expression for Flux}\label{subsec:an-expression-for-flux}
As the orbits already have been calculated in Part 2%~\parencite[][]{part2} TODO: Remove Comment
