...
\subsection{Lowering the orbit}\label{subsec:lowering-the-orbit}
    ...
    \colorbox{red}{The calculations for these values can be found in the appendix.}\\
...
As the temperature of the first two are equal (450 $ K $) which also matches earlier estimates made in \colorbox{red}{Jannik: Refferer til temp estimat i del 3} of the planets temperature, we will assume they are real lines.
