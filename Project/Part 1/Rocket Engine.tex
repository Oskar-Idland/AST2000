...
\section{Results}
	...
	The engine simulation yielded a momentum of $ 5.2 \cdot   10^{-19}kg \cdot  m / s $ per box. Divided by the total time $ \tau = 10^{-9}$ we get a force of of $ 10^{-11}N $ per box. Using a total number of $ 6 \cdot  10^{13} $ we get a thrust of $ 6 \cdot  10^{5} N $.
