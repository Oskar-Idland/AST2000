...
\subsection{Launching the Spacecraft}\label{subsec:launching-the-spacecraft}
    ...
    The exact duration of the boost, and therefore the change of velocity $\Delta v$ has been determined by the onboard computer.
    ...
    In other words, if~\eqref{formula1} is true
    \begin{align}
    ...
    The change of velocity $\Delta v$ depends on the velocity of the spacecraft before the boost, and the distance of the spacecraft to the center of the planet.
